...
const styles = {
  ...
  scaleBtn: { width: '32px', height: '32px', borderRadius: '8px', border: '1px solid #e5e7eb', background: '#f9fafb', cursor: 'pointer', fontSize: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  podRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: '1px solid #f3f4f6' },
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        {app.pods?.map(pod => (
          <div key={pod.name} style={styles.podRow}>
            <div>
